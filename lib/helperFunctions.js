...
module.exports = (db) => {
  ...
  return { getAllStories, getMyStories, getStoryById, createNewStory, getAllContributions, createNewContribution, getRandomStory, addUpvote, selectContribution, getContributionText }
}
